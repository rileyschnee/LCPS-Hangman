...
{ 
   ...
   public void paintComponent(Graphics g) {
      ...
      if (g1) {
         gD.drawOval(425, 50, 150, 150); // head
      } 
      if (g2) {
         gD.drawLine(500, 200, 500, 400); // body
      }  
      if (g3) {
         gD.drawLine(600, 500, 500, 400); // left leg
      }  
      if (g4) {
         gD.drawLine(400, 500, 500, 400); // right leg
      }  
      if (g5) {
         gD.drawLine(600, 350, 500, 300); // left arm
      }  
      if (g6) {
         gD.drawLine(400, 350, 500, 300); // right arm
         lose = true;
      } 
      ...
      if (lose){
         ...
         gD.drawString(goalWordStr, 125, 770);
      }
      if (win) {
